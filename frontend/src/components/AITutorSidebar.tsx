...
function buildSystemPrompt(context: AITutorSidebarProps['context']): string {
    const parts: string[] = [
        `Sen "S-STUDY" ta'lim platformasining AI maslahatchi assistantisan. Isming "SI-Maslahatchi".`,
            ...
            <CardHeader className="border-b px-4 py-3 bg-gradient-to-r from-indigo-50 to-purple-50 shrink-0">
                <CardTitle className="text-base flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-indigo-500 font-normal mt-0.5">Llama 3.3 · Groq AI</p>
                    </div>
                </CardTitle>
            </CardHeader>
